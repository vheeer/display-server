...
module.exports = (req, res) => {
  ...
  Promise
  .all([
    getData("select * from good where able=1"), 
    getData("select * from mess"),
    getData("select * from case_img where able=1"),
    getData("select * from good_img where able=1"),
    getData("select * from service_img where able=1"),
  ])
  .then(function([
    { rows: rows_good }, 
    { rows: rows_mess },
